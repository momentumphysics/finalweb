        ...
        <aside class="w-64 bg-white flex-shrink-0 shadow-lg hidden md:block">
            ...
            <nav class="mt-4">
                ...
                @can('is-dokter')
                    ...
                    <a href="{{ route('dokter.rekam-medis.index') }}" class="flex items-center px-6 py-3 text-gray-700 hover:bg-blue-50 hover:text-blue-700 {{ request()->routeIs('dokter.rekam-medis.*') ? 'bg-blue-100 border-l-4 border-blue-500 font-semibold text-blue-700' : '' }}">
                        <span class="mx-4">Rekam Medis</span>
                    </a>
